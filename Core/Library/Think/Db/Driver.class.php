...
abstract class Driver {
    ...
    protected $options = array(
        ...
        /** @brief  2018-11-26 zgt 尝试处理连接自动 断开Bug ，设置参数，增大连接空闲时长 连接空闲 最大时长 10天
        PDO::ATTR_PERSISTENT        =>  true,
        PDO::MYSQL_ATTR_INIT_COMMAND => "set interactive_timeout=864000;set wait_timeout=864000;", */
    );
    ...
    public function connect($config='',$linkNum=0,$autoConnection=false) {
        if ( !isset($this->linkID[$linkNum]) ) {
            ...
            try{
                ...
                //数据库超时重连 2018-12-11 14:22:38 @gy
                ...
                if(PHP_SAPI == 'cli'){
                    $query = $this->linkID[$linkNum]->prepare("set session wait_timeout=864000,interactive_timeout=864000,net_read_timeout=1000");
                    $query->execute();
                }
